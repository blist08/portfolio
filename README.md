...
**2-3-2. 이외 다수**
  ...
  > 11. **SURVEY INVITATION 객체**와 **CUSTOM 객체**를 연결하기 위한 **FLOW 구현** 및 **REPORT TYPE 생성**
  > 12. **KPI**에 직결되는 **대시보드 생성** 및 이를 위한 **REPORT 작성**
---
